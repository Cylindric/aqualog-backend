# api-parameter-catalog Specification

## Purpose
Define authenticated CRUD API behavior for the parameter catalog — the source-of-truth table of water parameter slugs (e.g. `salinity`, `phosphate`, `temperature`) referenced by aquarium measurements and thresholds, including validation, uniqueness, and deletion-guard semantics.
